...
//        log.info(AnsiOutput.toString(AnsiColor.BRIGHT_BLUE, "x-drive server started at: ", serverUrl));
//
//        if (checkShowServerDoc(applicationReadyEvent.getApplicationContext())) {
//            log.info(AnsiOutput.toString(AnsiColor.BRIGHT_BLUE, "x-drive server doc at: ", serverUrl + "/doc.html"));
//        }
//        log.info(AnsiOutput.toString(AnsiColor.BRIGHT_YELLOW, "x-drive server started successfully!"));
//    }
//
//    /**
//     * 检查是否开启了接口文档
